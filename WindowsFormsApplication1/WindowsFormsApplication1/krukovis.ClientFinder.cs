...
namespace PWFrameWork
{
    ...
    public class ClientFinder
    {
        ...
        private Int32 HostPlayerLvlOffset { get; set; }
        ...
        public ClientFinder(Int32 base_address, Int32 game_struct_offset, Int32 host_player_struct_offset, Int32 host_player_name_offset, Int32 host_player_lvl_offset)
        {
            ...
            HostPlayerLvlOffset = host_player_lvl_offset;
        }
        ...
        public IEnumerable<ClientWindow> ClientWindows
        {
            get
            {
                ...
                while (true)
                {
                    ...
                    if (personage_name != "")
                    {
                        int personage_lvl = memory.ChainReadInt32(this.BaseAddress, this.GameStructOffset, this.HostPlayerStructOffset, this.HostPlayerLvlOffset);
                        //добавляем в список окон окно с именем персонажа
                        string pn = String.Format("{0} [{1}]",personage_name,personage_lvl.ToString());
                        yield return new ClientWindow(pn, process_id);
                    }
                    else
                    {
